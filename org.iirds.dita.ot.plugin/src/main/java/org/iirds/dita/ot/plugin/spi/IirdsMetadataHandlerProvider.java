...
/**
 * Provider for {@link IirdsMetadataHandler} implementations. Implementation classes
 * must be registered in
 * {@code META-INF/services/org.iirds.dita.ot.plugin.spi.IirdsMetadataHandlerProvider}
 * according to
