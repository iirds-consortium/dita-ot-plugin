...
/**
 * An {@link IRIHandlerProvider} implementation providing an instance of
 * {@link CSVIriHandler}.
 * 
 * @author Martin Kreutzer, Empolis Information Management GmbH
 *
 */
public class CSVIriHandlerProvider implements IRIHandlerProvider {

	@Override
	public IRIHandler create() {
		return new CSVIriHandler();
	}
